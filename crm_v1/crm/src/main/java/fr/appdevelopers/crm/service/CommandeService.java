...
public class CommandeService {
    ...
    public boolean validerIdClient(String idUtilisateur, RedirectAttributes redirectAttributes) {
    ...
    public int creerCommande(String idUtilisateur, Date dateCommande, List<Integer> produitsIds, int idEmploye, Map<String, String> formData) {
        Commande commande = new Commande();
        commande.setDateCommande(dateCommande);
        commande.setStatutLivraison(StatutLivraison.EN_PREPARATION);
        Client client = clientService.getClientById(Integer.parseInt(idUtilisateur));
